...
const dict: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    // Settings – plan
    plan_title: 'プラン',
    plan_subtitle: '現在のプランと請求情報を確認できます。',
    ...
    plan_upgrade_cta: 'Starter にアップグレード',
    plan_checkout_failed: 'チェックアウトの開始に失敗しました',
    plan_modal_title: 'Starter にアップグレード',
    plan_modal_subtitle: '14日間の無料トライアル付き。いつでもキャンセルできます。',
    plan_modal_per_month: '/ 月',
    plan_modal_trial_note: 'トライアル終了後に自動課金が開始されます。',
    plan_modal_cta: 'アップグレードする',
    plan_modal_redirecting: '移動中...',
    plan_feat_unlimited_items: '連携サービス数 無制限',
    plan_feat_history: 'コスト履歴 無制限',
    plan_feat_email_forward: 'メール転送による請求書自動取込',
    plan_feat_alerts: 'しきい値アラート',
  ...
  en: {
    ...
    // Settings – plan
    plan_title: 'Plan',
    plan_subtitle: 'View your current plan and billing details.',
    ...
    plan_upgrade_cta: 'Upgrade to Starter',
    ...
    plan_modal_per_month: '/ month',
    plan_modal_trial_note: 'Billing starts automatically after the trial ends.',
    plan_modal_cta: 'Upgrade',
    plan_modal_redirecting: 'Redirecting...',
    plan_feat_unlimited_items: 'Unlimited connected services',
    plan_feat_history: 'Unlimited cost history',
    plan_feat_email_forward: 'Automatic invoice import via email forwarding',
    plan_feat_alerts: 'Threshold alerts',
