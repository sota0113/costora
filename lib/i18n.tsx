...
const dict: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    plan_card_starter_users: '5ユーザーまで',
    ...
    plan_card_scale_cap: '管理ITスペンド上限 カスタム',
  ...
  en: {
    ...
    plan_card_starter_users: 'Up to 5 users',
    ...
    plan_card_scale_cap: 'Custom managed IT spend cap',
