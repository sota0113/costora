...
const dict: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    // Settings – plan
    plan_title: 'プラン',
    plan_subtitle: '事業の成長に合わせてスケールできます。',
    plan_updating: 'プランを更新中...',
    plan_status_trialing: 'トライアル中',
    plan_status_active: '有効',
    plan_status_past_due: '支払い遅延',
    plan_status_canceled: '解約済み',
    plan_status_incomplete: '手続き中',
    plan_trial_ends: 'トライアル終了日: {date}',
    plan_renews_on: '次回更新日: {date}',
    plan_upgrade_cta: '14日間無料で始める',
    plan_checkout_failed: 'チェックアウトの開始に失敗しました',
    plan_manage_cta: 'プランを管理する',
    plan_manage_failed: 'ポータルへの移動に失敗しました',
    plan_usage_badge_label: '{plan} 利用状況',
    plan_usage_caption: '{spend} / {cap} ・ {pct}%',
    plan_card_free_tagline: '個人や小さなチームに',
    plan_card_usage_pct: '利用率 {pct}%',
    plan_card_cap_line: '管理ITスペンド上限 {cap}',
    plan_card_free_users: '1ユーザーまで',
    plan_card_free_services: '連携サービス数 3件まで',
    plan_card_free_history: 'コスト履歴 直近3ヶ月',
    plan_card_no_trial: 'トライアルなし',
    plan_badge_current: 'ご利用中',
    plan_badge_recommended: 'おすすめ',
    plan_card_starter_tagline: '成長中の小チームに',
    plan_card_per_month: '/ 月',
    plan_card_trial_badge: '14日間無料トライアル',
    plan_card_starter_users: '3ユーザーまで',
    plan_card_starter_unlimited: '連携サービス数 無制限',
    plan_card_starter_features: 'メール転送による請求書自動取込',
    plan_badge_coming_soon: '近日公開',
    plan_card_growth_tagline: '成長企業に',
    plan_card_growth_includes: 'Starter のすべての機能を含む',
    plan_card_users_unlimited: 'ユーザー数 無制限',
    plan_card_growth_alloc: '部門別の高度な按分機能',
    plan_card_scale_tagline: '大規模組織に',
    plan_card_scale_includes: 'Growth のすべての機能を含む',
    plan_card_scale_price: '要相談',
    plan_card_scale_cap: '管理ITスペンド上限 無制限',
    plan_card_scale_support: '専任サポート',
    plan_footnote: '価格はすべて税抜・米ドル建てです。プランはいつでも変更・解約できます。',
    plan_modal_badge: '14日間無料トライアル',
    plan_modal_title: 'Starter にアップグレード',
    plan_modal_subtitle: '14日間の無料トライアル付き。いつでもキャンセルできます。',
    plan_modal_per_month: '/ 月（トライアル終了後）',
    plan_modal_feat_spend_cap: '管理ITスペンド上限 {cap}（{multiplier}倍）',
    plan_modal_feat_users: '5ユーザーまで利用可能',
    plan_modal_feat_email: 'メール転送による請求書自動取込',
    plan_modal_feat_alerts: 'しきい値アラート',
    plan_modal_trial_note: '{date} まで無料でお試しいただけます。トライアル終了後に自動課金が開始されます。',
    plan_modal_cta: 'アップグレードする',
    plan_modal_redirecting: '移動中...',
  ...
  en: {
    ...
    // Settings – plan
    plan_title: 'Plan',
    plan_subtitle: 'Scale your plan as your business grows.',
    ...
    plan_status_incomplete: 'Pending',
    plan_trial_ends: 'Trial ends: {date}',
    plan_renews_on: 'Renews on: {date}',
    plan_upgrade_cta: 'Start your 14-day free trial',
    plan_checkout_failed: 'Failed to start checkout',
    plan_manage_cta: 'Manage plan',
    plan_manage_failed: 'Failed to open billing portal',
    plan_usage_badge_label: '{plan} usage',
    plan_usage_caption: '{spend} / {cap} · {pct}%',
    plan_card_free_tagline: 'For individuals and small teams',
    plan_card_usage_pct: '{pct}% used',
    plan_card_cap_line: '{cap} managed IT spend cap',
    plan_card_free_users: 'Up to 1 user',
    plan_card_free_services: 'Up to 3 connected services',
    plan_card_free_history: '3-month cost history',
    plan_card_no_trial: 'No trial',
    plan_badge_current: 'Current plan',
    plan_badge_recommended: 'Recommended',
    plan_card_starter_tagline: 'For growing small teams',
    plan_card_per_month: '/ month',
    plan_card_trial_badge: '14-day free trial',
    plan_card_starter_users: 'Up to 3 users',
    plan_card_starter_unlimited: 'Unlimited connected services',
    plan_card_starter_features: 'Automatic invoice import via email forwarding',
    plan_badge_coming_soon: 'Coming soon',
    plan_card_growth_tagline: 'For scaling companies',
    plan_card_growth_includes: 'Everything in Starter, plus',
    plan_card_users_unlimited: 'Unlimited users',
    plan_card_growth_alloc: 'Advanced department allocation',
    plan_card_scale_tagline: 'For large organizations',
    plan_card_scale_includes: 'Everything in Growth, plus',
    plan_card_scale_price: 'Contact us',
    plan_card_scale_cap: 'Unlimited managed IT spend',
    plan_card_scale_support: 'Dedicated support',
    plan_footnote: 'All prices are in USD, excluding tax. Change or cancel your plan anytime.',
    plan_modal_badge: '14-day free trial',
    plan_modal_title: 'Upgrade to Starter',
    plan_modal_subtitle: 'Includes a 14-day free trial. Cancel anytime.',
    plan_modal_per_month: '/ month (after trial)',
    plan_modal_feat_spend_cap: '{cap} managed IT spend cap ({multiplier}x)',
    plan_modal_feat_users: 'Up to 5 users',
    plan_modal_feat_email: 'Automatic invoice import via email forwarding',
    plan_modal_feat_alerts: 'Threshold alerts',
    plan_modal_trial_note: 'Try it free until {date}. Billing starts automatically after the trial ends.',
    plan_modal_cta: 'Upgrade',
    plan_modal_redirecting: 'Redirecting...',
